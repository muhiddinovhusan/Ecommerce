...
<button id="addToCart" onclick="addToCart(${product.id})"><i class="fa-solid fa-plus"></i> <i class="fa-solid fa-cart-shopping"></i></button>
</a>
...
function addToCart(productId) {
    ...
    if (!hasProduct) {
        ...
        alert('siz tanlagan buyum korzinkaga qoshildi');
    }
