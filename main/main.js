    ...
    products.forEach((product) => {
        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <button id="info-button" onclick="goDetails(${product.id})"><i class="fa-solid fa-info"></i></button>
            </a>
...
localStorage.setItem('product1',JSON.stringify(products));

/////srch

// SrchBtn.addEventListener('click', function () {
//     let display = products.map((item) => {
//         const {  img , category, price, description,name } = item;
//         if (item.category === SrchInp.value) {
//             return `
//             <div class="card">
//           <img src="${img}" />
//           <div class="card-content">
...
SrchInp.addEventListener('input', function(e){
    ...
    let products = JSON.parse(localStorage.getItem('product1'));
    let newProduct = products.filter((products)=> 
    products.category.toLowerCase().includes(text) || 
    products.name.toLowerCase().includes(text)  
    )
